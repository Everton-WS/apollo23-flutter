...
class ActivityRepository {
  ...
  static Future<ActivityModel> getActivityById(id) async {
    String unencodedPath = "api/activities/$id";
    ...
    ActivityModel activity = ActivityModel.fromJson(respostaObj as JsonMap);
    return activity;
  }

  static Future<List<ActivityModel>> getActivitiesByEventId(eventId) async {
    String unencodedPath = "api/events/$eventId/activities";
    Uri uri = Uri.https (HTTPS_AUTHORITY, unencodedPath);
    ...
    (respostaObj["results"] as List<dynamic>).forEach((element) {
      activityList.add(ActivityModel.fromJson(element as JsonMap));
    });
    return activityList;
  }
